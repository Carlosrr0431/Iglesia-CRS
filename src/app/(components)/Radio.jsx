...
const Radio = () => {
  ...
  return (
    ...
    >
      <div className="mb-[70px] md:mb-0 -mt-8 md:mt-0 items-center h-[200px]  w-[280px] md:h-[450px]  md:w-[280px]  rounded-[5px] mx-auto flex flex-col justify-around shadow-2xl shadow-black/60  bg-white/90">
        {/* mt-8 items-center -space-y-2 text-center flex flex-col justify-center */}
        <div className=" flex justify-center items-center md:flex md:flex-col md:text-center md:mt-8 flex-nowrap">
