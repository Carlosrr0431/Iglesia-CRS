...

            {
                ...
                <div className='fixed  inset-0 bg-white z-50 bg-opacity-75 backdrop-blur-sm flex  h-[80%] sm:w-[50%]  w-[80%] mx-auto sm:mx-[25%] my-[5%] flex-col space-y-2 '>
                    <div className='flex justify-center gap-x-2 md:gap-x-8 mt-10'>
                        ...
                        >
                            Libro <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        ...
                        >
                            Capitulo <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        </button>
                        ...
                        >
                            Versiculo <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4" />
                            </svg>
                        </button>
                    </div>
