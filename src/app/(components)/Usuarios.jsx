...
export const Usuarios = () => {
    ...
    useEffect(() => {
        ...
        const channelUsuarios = supabaseClient
            .channel('autorizados')
            .on('postgres_changes', { event: '*', schema: 'public', table: 'autorizados' }, (payload) => {
    ...
    return (
        ...
        <div class="relative flex flex-col w-[80%] h-full text-gray-700  bg-clip-border  right-[30px] ">
                                ...
                                <tr key={index}>
                                    ...
                                    <td class="p-4 border-b border-blue-gray-50">
                                        <button
                                            ...
                                            onClick={ async() => 
                                                await userAdmin(null, "Eliminar", Number(user.id) )
                                            }
